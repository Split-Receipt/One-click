      ...
      <div className={`${className}`}>
        <div className="container">
          ...
          <div className="features-grid">
            <div className="feature-card area-a">
            ...
            <div className="feature-card area-b">
            ...
            <div className="feature-card area-c">video</div>
            <div className="feature-card area-d bg-[url('public/img/background.svg')] bg-cover bg-top">
            ...
            <div className="feature-card area-e">
            ...
            <div className="feature-card area-f">
            ...
            <div className="feature-card area-g">
            ...
            <div className="feature-card area-h">
